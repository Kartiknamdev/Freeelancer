...
const TaskHistory = () => {
  ...
  useEffect(() => {
    ...
    if (typeFilter === 'created') {
      userTasks = getTasksByCreator(user.id)
    } else if (typeFilter === 'assigned') {
      userTasks = getTasksByWorker(user.id)
    } else if (typeFilter === 'applied') {
      userTasks = getTasksAppliedTo(user.id)
    }
          ...
          <div className="relative flex-1 min-w-[200px]">
            ...
            >
              ...
              <span className="text-xs bg-gray-100 py-1 px-2 rounded-full">
                {typeFilter === 'created' ? 'Created by me' : 
                 typeFilter === 'assigned' ? 'Assigned to me' : 
                 'Applied by me'}
